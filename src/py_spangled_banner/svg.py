...
def _append_rect_stripes(
    ...
    <defs>
        ...
        <rect id="short_{white_id}" width="{measurements.width-measurements.canton_width}" height="{measurements.stripe_height}" fill="{colors.inner_stripes}" x="{measurements.canton_width}"/>
    </defs>''')
